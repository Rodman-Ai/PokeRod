...
function applyWorldExpansion(MAPS) {
  ...
  // ----- New themed zones (Amusement Park, Castle, Casino) -----
  ...
  MAPS.pokerod_amusement_park = {
    ...
    npcs: [
      ...
      { x:6, y:7, dir:'right', sprite:'npc_ride_op', name:'RIDE OP RUSS', wander:{ range:1 },
        dialog:["The carousel goes ALL day!","Hold your hat on the loop."] },
      { x:24, y:7, dir:'left', sprite:'npc_mascot', name:'MASCOT BUNBUN',
        dialog:["..!","..(squeak)..!"] },
      { x:14, y:11, dir:'down', sprite:'npc_kid_balloon', name:'BALLOON GIRL VIE',
        dialog:["Pop! Pop! Pop!","Mine is the red one. Don't grab it."] },
      { x:8, y:13, dir:'right', sprite:'npc_acrobat', name:'ACROBAT KAEDE', wander:{ range:1 },
        dialog:["Three flips. Stuck the landing.","Bet you can't do four."] },
      { x:20, y:13, dir:'left', sprite:'clerk', name:'MERCH CLERK ZOE',
        dialog:["Plushies! Pins! Park t-shirts!","Trade your tickets at the prize counter."] },
      { x:8, y:5, dir:'down', sprite:'npc_old_woman', name:'GRANNY POPCORN MAE',
        dialog:["Hot popcorn, fresh kettle corn.","Stay a while, dear."] },
      { x:20, y:5, dir:'down', sprite:'npc_kid_boy', name:'TICKET KID JIN', wander:{ range:1 },
        dialog:["I traded twenty tickets for THIS pin!"] },
      { x:6, y:16, dir:'right', sprite:'npc_dog_walker', name:'PARADE LEAD HUGO', wander:{ range:1 },
        dialog:["The parade starts at the fountain.","Stay clear of the floats!"] },
      { x:24, y:16, dir:'left', sprite:'npc_kid_girl', name:'COTTON CANDY KID',
        dialog:["I want PINK and BLUE and YELLOW!"] }
    ],
    decorations: [
      { x:6,  y:1,  key:'decor_amu_balloon_red'    },
      { x:11, y:1,  key:'decor_amu_balloon_blue'   },
      { x:16, y:1,  key:'decor_amu_balloon_yellow' },
      { x:21, y:1,  key:'decor_amu_pinwheel'       },
      { x:6,  y:3,  key:'decor_amu_carnival_flag'  },
      { x:21, y:3,  key:'decor_amu_carnival_flag'  },
      { x:5,  y:5,  key:'decor_amu_popcorn_cart'   },
      { x:23, y:5,  key:'decor_amu_ice_cream'      },
      { x:14, y:8,  key:'decor_amu_carousel_horse' },
      { x:5,  y:9,  key:'decor_amu_lantern'        },
      { x:23, y:9,  key:'decor_amu_lantern'        },
      { x:9,  y:11, key:'decor_amu_jackpot_light'  },
      { x:19, y:11, key:'decor_amu_jackpot_light'  },
      { x:11, y:12, key:'decor_amu_food_cart'      },
      { x:17, y:12, key:'decor_amu_prize_tent'     },
      { x:5,  y:14, key:'decor_amu_string_lights'  },
      { x:23, y:14, key:'decor_amu_string_lights'  },
      { x:9,  y:15, key:'decor_amu_dart_wall'      },
      { x:19, y:15, key:'decor_amu_ring_toss'      },
      { x:14, y:9,  key:'decor_amu_mascot_statue'  },
      { x:7,  y:9,  key:'decor_amu_photo_booth'    },
      { x:21, y:9,  key:'decor_amu_ticket_booth'   },
      { x:13, y:13, key:'decor_amu_plush_prize'    },
      { x:15, y:13, key:'decor_amu_plush_prize'    }
    ],
    doors: {
  ...
  MAPS.pokerod_castle = {
    ...
    npcs: [
      ...
      { x:13, y:11, dir:'down', sprite:'npc_queen', name:'QUEEN MAVRA',
        dialog:["The roses bloom early this year.","An auspicious sign."] },
      { x:9, y:13, dir:'right', sprite:'npc_knight', name:'SIR BRENN', wander:{ range:1 },
        dialog:["The portcullis stays half-raised by day.","No threat for fifty years."] },
      { x:19, y:13, dir:'left', sprite:'npc_knight', name:'DAME ESYR', wander:{ range:1 },
        dialog:["My armor is heavier than your dragon.","I trained for years to wear it."] },
      { x:14, y:14, dir:'up', sprite:'npc_jester', name:'JESTER PIPP',
        dialog:["What walks on four legs at dawn,","Two at noon, three at dusk?"] },
      { x:11, y:14, dir:'right', sprite:'npc_squire', name:'SQUIRE WILLO', wander:{ range:1 },
        dialog:["I polish the boots and the helmets.","Someday I'll lift the broadsword."] },
      { x:17, y:14, dir:'left', sprite:'npc_squire', name:'SQUIRE TANN', wander:{ range:1 },
        dialog:["The banners come down at sunset.","Up at dawn. It's a job."] },
      { x:5, y:16, dir:'right', sprite:'npc_old', name:'ROYAL ADVISOR ARDEL',
        dialog:["The annals run back two hundred reigns.","Care to read a chapter?"] },
      { x:23, y:16, dir:'left', sprite:'npc_old_woman', name:'QUEEN MOTHER VEYLA',
        dialog:["My grandson grew up in this hall.","Now he rules it gently."] },
      { x:14, y:15, dir:'down', sprite:'clerk', name:'STEWARD ROBYN',
        dialog:["The royal coffer is half full,","which is to say, half empty."] }
    ],
    decorations: [
      { x:8,  y:5,  key:'decor_cas_banner_red'    },
      { x:18, y:5,  key:'decor_cas_banner_blue'   },
      { x:11, y:5,  key:'decor_cas_kings_crown'   },
      { x:15, y:5,  key:'decor_cas_coat_of_arms'  },
      { x:9,  y:7,  key:'decor_cas_chandelier'    },
      { x:13, y:7,  key:'decor_cas_chandelier'    },
      { x:17, y:7,  key:'decor_cas_chandelier'    },
      { x:8,  y:9,  key:'decor_cas_armor_full'    },
      { x:18, y:9,  key:'decor_cas_armor_full'    },
      { x:10, y:9,  key:'decor_cas_candelabra'    },
      { x:16, y:9,  key:'decor_cas_candelabra'    },
      { x:13, y:9,  key:'decor_cas_throne'        },
      { x:14, y:9,  key:'decor_cas_kings_crown'   },
      { x:8,  y:11, key:'decor_cas_painting'      },
      { x:18, y:11, key:'decor_cas_painting'      },
      { x:10, y:11, key:'decor_cas_tapestry'      },
      { x:16, y:11, key:'decor_cas_tapestry'      },
      { x:11, y:12, key:'decor_cas_royal_table'   },
      { x:13, y:12, key:'decor_cas_pewter_goblet' },
      { x:15, y:12, key:'decor_cas_scroll'        },
      { x:17, y:12, key:'decor_cas_globe'         },
      { x:8,  y:13, key:'decor_cas_treasure_chest'},
      { x:18, y:13, key:'decor_cas_treasure_chest'},
      { x:9,  y:13, key:'decor_cas_sword_display' },
      { x:19, y:13, key:'decor_cas_weapon_rack'   },
      { x:11, y:13, key:'decor_cas_rose_vase'     },
      { x:17, y:13, key:'decor_cas_rose_vase'     },
      { x:13, y:14, key:'decor_cas_fireplace'     },
      { x:15, y:14, key:'decor_cas_knight_armor'  }
    ],
    doors: {
  ...
  MAPS.pokerod_casino = {
    ...
    npcs: [
      ...
      { x:18, y:5, dir:'left', sprite:'npc_dealer', name:'DEALER FLINT', wander:{ range:1 },
        dialog:["Black on red, red on black.","The wheel doesn't care, neither do I."] },
      { x:14, y:7, dir:'down', sprite:'npc_pit_boss', name:'PIT BOSS MARCO',
        dialog:["No funny business at the tables.","I'm watching every spin."] },
      { x:11, y:9, dir:'right', sprite:'npc_high_roller', name:'WHALE PLAYER VANCE',
        dialog:["I came in with ten thousand.","I'll leave with twenty. Watch me."] },
      { x:16, y:9, dir:'left', sprite:'npc_high_roller', name:'BIG WIN BERTHA',
        dialog:["Hit the jackpot last Tuesday.","Buying everyone a drink tonight."] },
      { x:11, y:11, dir:'right', sprite:'npc_showgirl', name:'SHOWGIRL DELILAH', wander:{ range:1 },
      ...
      { x:14, y:14, dir:'down', sprite:'clerk', name:'CASHIER MIRA',
        dialog:["Cash in, cash out.","We pay in coupons, redeem at the prize counter."] }
    ],
    decorations: [
      { x:8,  y:1,  key:'decor_csn_neon_arrow'    },
      { x:18, y:1,  key:'decor_csn_neon_sign_2'   },
      { x:12, y:1,  key:'decor_csn_dollar_sign'   },
      { x:8,  y:4,  key:'decor_csn_velvet_curtain'},
      { x:18, y:4,  key:'decor_csn_velvet_curtain'},
      { x:9,  y:6,  key:'decor_csn_chip_stack_red'},
      { x:18, y:6,  key:'decor_csn_chip_stack_blue'},
      { x:11, y:6,  key:'decor_csn_dice'          },
      { x:14, y:6,  key:'decor_csn_jackpot_light' },
      { x:16, y:6,  key:'decor_csn_dice'          },
      { x:9,  y:8,  key:'decor_csn_slot_lever'    },
      { x:18, y:8,  key:'decor_csn_slot_lever'    },
      { x:11, y:8,  key:'decor_csn_chip_wheel'    },
      { x:14, y:8,  key:'decor_csn_royal_flush'   },
      { x:16, y:8,  key:'decor_csn_chip_wheel'    },
      { x:9,  y:10, key:'decor_csn_dealer_chair'  },
      { x:18, y:10, key:'decor_csn_dealer_chair'  },
      { x:14, y:10, key:'decor_csn_prize_wheel'   },
      { x:9,  y:12, key:'decor_csn_drink'         },
      { x:18, y:12, key:'decor_csn_cocktail_tray' },
      { x:11, y:12, key:'decor_csn_microphone'    },
      { x:14, y:12, key:'decor_csn_jukebox'       },
      { x:16, y:12, key:'decor_csn_drink'         },
      { x:8,  y:14, key:'decor_csn_prize_counter' },
      { x:18, y:14, key:'decor_csn_vending_machine'},
      { x:11, y:14, key:'decor_csn_mirror'        },
      { x:16, y:14, key:'decor_csn_mirror'        },
      { x:13, y:14, key:'decor_csn_chip_stack_red'},
      { x:15, y:14, key:'decor_csn_chip_stack_blue'}
    ],
    doors: {
